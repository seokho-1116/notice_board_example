...
import com.example.noticeboardexample.controller.AuthRestController;
...
@TestConfiguration
@Import({SecurityConfig.class, AuthRestController.class, TokenService.class, EndUserService.class,
